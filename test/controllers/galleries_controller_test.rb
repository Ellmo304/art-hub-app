...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { address: @gallery.address, body: @gallery.body, image: @gallery.image, name: @gallery.name, tube: @gallery.tube } }, as: :json
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { address: @gallery.address, body: @gallery.body, image: @gallery.image, name: @gallery.name, tube: @gallery.tube } }, as: :json
    assert_response 200
  end
